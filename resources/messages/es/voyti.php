...
return [
    ...
    'voyti.validator.password_min_length' => 'La contraseña debe contener al menos {minimum, plural, one{# carácter} other{# caracteres}}.',
    'voyti.validator.password_max_length' => 'La contraseña debe contener como máximo {minimum, plural, one{# carácter} other{# caracteres}}.',
    'voyti.validator.password_min_uppercase' => 'La contraseña debe contener al menos {minimum, plural, one{# mayúscula} other{# mayúsculas}}.',
    'voyti.validator.password_min_lowercase' => 'La contraseña debe contener al menos {minimum, plural, one{# minúscula} other{# minúsculas}}.',
    'voyti.validator.password_min_digits' => 'La contraseña debe contener al menos {minimum, plural, one{# dígito} other{# dígitos}}.',
    'voyti.validator.password_min_symbols' => 'La contraseña debe contener al menos {minimum, plural, one{# símbolo} other{# símbolos}}.',
