...
return [
    ...
    'voyti.admin.impersonate_identity_success' => 'Ahora ha iniciado sesión como este usuario',
    'voyti.admin.impersonate_identity_restored' => 'Se ha restaurado su identidad original',
    ...
    // UserCreationHelper
    'voyti.user.email_already_exists' => 'El correo electrónico ya existe',
    'voyti.user.username_already_exists' => 'El nombre de usuario ya existe',
    'voyti.user.email_or_username_already_exists' => 'Ya existe un usuario con este correo electrónico o nombre de usuario.',

    'voyti.validator.password_min_length' => 'La contraseña debe contener al menos {minimum} {minimum, plural, one{carácter} other{caracteres}}.',
    'voyti.validator.password_max_length' => 'La contraseña debe contener como máximo {minimum} {minimum, plural, one{carácter} other{caracteres}}.',
    'voyti.validator.password_min_uppercase' => 'La contraseña debe contener al menos {minimum} {minimum, plural, one{mayúscula} other{mayúsculas}}.',
    'voyti.validator.password_min_lowercase' => 'La contraseña debe contener al menos {minimum} {minimum, plural, one{minúscula} other{minúsculas}}.',
    'voyti.validator.password_min_digits' => 'La contraseña debe contener al menos {minimum} {minimum, plural, one{dígito} other{dígitos}}.',
    'voyti.validator.password_min_symbols' => 'La contraseña debe contener al menos {minimum} {minimum, plural, one{símbolo} other{símbolos}}.',
    ...
    'voyti.view.registration.data_processing_consent_label' => 'Acepto el tratamiento de mis datos personales',
    ...
    'voyti.view.settings.welcome' => '¡Bienvenido, {name}!',
    'voyti.view.settings.member_since' => 'Miembro desde',
    ...
    'voyti.view.delete_account.invalid_password' => 'Contraseña incorrecta',
    ...
    'voyti.view.admin.impersonate_button' => 'Suplantar',
    'voyti.view.admin.restore_button' => 'Restaurar',
    'voyti.view.admin.impersonating_banner' => 'Actualmente ha iniciado sesión como este usuario. Haga clic en Restaurar para volver a {username}.',
    ...
    // Dashboard view
    'voyti.view.dashboard.title' => 'Panel de control',
    'voyti.view.dashboard.users_total' => 'Usuarios totales',
    'voyti.view.dashboard.users_blocked' => 'Usuarios bloqueados',
    'voyti.view.dashboard.users_unconfirmed' => 'Usuarios sin confirmar',
    'voyti.view.dashboard.roles' => 'Roles',
    'voyti.view.dashboard.permissions' => 'Permisos',
    'voyti.view.dashboard.rules' => 'Reglas',
    'voyti.view.dashboard.recent_activity' => 'Actividad reciente',
    'voyti.view.dashboard.no_recent_activity' => 'Sin actividad reciente.',
    'voyti.view.dashboard.new_registrations' => 'Nuevos registros',
    'voyti.view.dashboard.active_sessions' => 'Sesiones activas',
    'voyti.view.dashboard.last_1d' => 'Últimas 24 horas',
    'voyti.view.dashboard.last_7d' => 'Últimos 7 días',
    'voyti.view.dashboard.last_lifespan' => 'Últimos {days} días',
    'voyti.view.dashboard.recommended_addons' => 'Complementos recomendados',
    'voyti.view.dashboard.view_on_packagist' => 'Ver en Packagist',
    'voyti.view.dashboard.documentation' => 'Documentación',
    'voyti.view.dashboard.package_api_label' => 'API REST',
    'voyti.view.dashboard.package_api_description' => 'Comparta su sistema de usuarios como una API REST moderna con autenticación integrada.',
    'voyti.view.dashboard.package_gdpr_label' => 'Cumplimiento GDPR',
    ...
    'voyti.view.dashboard.package_2fa_email_description' => 'Seguridad adicional con códigos de correo. protege instantáneamente contra robo de contraseñas.',
    'voyti.view.dashboard.package_2fa_totp_label' => 'Autenticación de dos factores (TOTP)',
    'voyti.view.dashboard.package_2fa_totp_description' => 'Seguridad de nivel militar con aplicaciones autenticadoras. seguro incluso si se compromete la contraseña.',
    'voyti.view.dashboard.package_2fa_webauthn_label' => 'Autenticación de dos factores (WebAuthn)',
    'voyti.view.dashboard.package_2fa_webauthn_description' => 'El futuro de la seguridad. autenticación biométrica o de clave de hardware para máxima protección.',
