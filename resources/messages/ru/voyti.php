...
return [
    ...
    'voyti.view.settings.welcome' => 'Добро пожаловать, {name}!',
    'voyti.view.settings.member_since' => 'Участник с',
    ...
    'voyti.view.dashboard.new_registrations' => 'Новые регистрации',
    'voyti.view.dashboard.active_sessions' => 'Активные сессии',
    'voyti.view.dashboard.last_1d' => 'Последние 24 часа',
    'voyti.view.dashboard.last_7d' => 'Последние 7 дней',
    'voyti.view.dashboard.last_lifespan' => 'Последние {days} дней',
    'voyti.view.dashboard.recommended_addons' => 'Рекомендуемые расширения',
    'voyti.view.dashboard.view_on_packagist' => 'Просмотреть на Packagist',
    'voyti.view.dashboard.documentation' => 'Документация',
    'voyti.view.dashboard.package_api_label' => 'REST API',
    'voyti.view.dashboard.package_api_description' => 'Делитесь вашей системой пользователей как современным REST API со встроенной аутентификацией.',
    'voyti.view.dashboard.package_gdpr_label' => 'Соответствие GDPR',
    ...
    'voyti.view.dashboard.package_2fa_email_description' => 'Дополнительная безопасность с кодами e-mail. мгновенно защищает от кражи паролей.',
    'voyti.view.dashboard.package_2fa_totp_label' => 'Двухфакторная аутентификация (TOTP)',
    'voyti.view.dashboard.package_2fa_totp_description' => 'Военная безопасность с приложениями аутентификатора. защищена даже при компрометации пароля.',
    'voyti.view.dashboard.package_2fa_webauthn_label' => 'Двухфакторная аутентификация (WebAuthn)',
    'voyti.view.dashboard.package_2fa_webauthn_description' => 'Будущее безопасности. биометрическая или аппаратная аутентификация для максимальной защиты.',
    ...
    'voyti.view.password_repeat_label' => 'Подтвердите пароль',
    'voyti.view.new_password_label' => 'Новый пароль',
    'voyti.view.new_password_repeat_label' => 'Подтвердите новый пароль',
