...
return [
    ...
    'voyti.validator.password_min_length' => 'Das Passwort muss mindestens {minimum, plural, one{# Zeichen} other{# Zeichen}} enthalten.',
    'voyti.validator.password_max_length' => 'Das Passwort darf höchstens {minimum, plural, one{# Zeichen} other{# Zeichen}} enthalten.',
    'voyti.validator.password_min_uppercase' => 'Das Passwort muss mindestens {minimum, plural, one{# Großbuchstaben} other{# Großbuchstaben}} enthalten.',
    'voyti.validator.password_min_lowercase' => 'Das Passwort muss mindestens {minimum, plural, one{# Kleinbuchstaben} other{# Kleinbuchstaben}} enthalten.',
    'voyti.validator.password_min_digits' => 'Das Passwort muss mindestens {minimum, plural, one{# Ziffer} other{# Ziffern}} enthalten.',
    'voyti.validator.password_min_symbols' => 'Das Passwort muss mindestens {minimum, plural, one{# Sonderzeichen} other{# Sonderzeichen}} enthalten.',
    ...
    'voyti.view.registration.data_processing_consent_label' => 'Ich stimme der Verarbeitung meiner personenbezogenen Daten zu',
    ...
    'voyti.view.dashboard.recommended_addons' => 'Empfohlene Erweiterungen',
    'voyti.view.dashboard.view_on_packagist' => 'Auf Packagist ansehen',
    'voyti.view.dashboard.documentation' => 'Dokumentation',
    'voyti.view.dashboard.package_api_label' => 'REST-API',
    'voyti.view.dashboard.package_api_description' => 'Teilen Sie Ihr Benutzersystem als moderne REST-API mit eingebauter Authentifizierung.',
    'voyti.view.dashboard.package_gdpr_label' => 'DSGVO-Compliance',
    ...
    'voyti.view.dashboard.package_lockout_label' => 'Brute-Force-Schutz',
    'voyti.view.dashboard.package_lockout_description' => 'Verfolgen Sie fehlgeschlagene Anmelde- und Registrierungsversuche pro IP-Adresse und blockieren Sie weitere Versuche, sobald der Schwellenwert erreicht ist.',
    ...
    'voyti.view.dashboard.package_2fa_totp_description' => 'Militärische Sicherheit mit Authentifizierungs-Apps. auch bei Passwortleck sicher.',
    'voyti.view.dashboard.package_2fa_webauthn_label' => 'Zwei-Faktor-Auth (WebAuthn)',
    'voyti.view.dashboard.package_2fa_webauthn_description' => 'Die Zukunft der Sicherheit. biometrische oder Hardware-Authentifizierung für maximalen Schutz.',
