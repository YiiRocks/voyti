...
return [
    ...
    'voyti.validator.password_min_length' => 'Het wachtwoord moet minstens {minimum, plural, one{# teken} other{# tekens}} bevatten.',
    'voyti.validator.password_max_length' => 'Het wachtwoord mag maximaal {minimum, plural, one{# teken} other{# tekens}} bevatten.',
    'voyti.validator.password_min_uppercase' => 'Het wachtwoord moet minstens {minimum, plural, one{# hoofdletter} other{# hoofdletters}} bevatten.',
    'voyti.validator.password_min_lowercase' => 'Het wachtwoord moet minstens {minimum, plural, one{# kleine letter} other{# kleine letters}} bevatten.',
    'voyti.validator.password_min_digits' => 'Het wachtwoord moet minstens {minimum, plural, one{# cijfer} other{# cijfers}} bevatten.',
    'voyti.validator.password_min_symbols' => 'Het wachtwoord moet minstens {minimum, plural, one{# symbool} other{# symbolen}} bevatten.',
    ...
    'voyti.view.dashboard.recommended_addons' => 'Aanbevolen uitbreidingen',
    'voyti.view.dashboard.view_on_packagist' => 'Bekijken op Packagist',
    'voyti.view.dashboard.documentation' => 'Documentatie',
    'voyti.view.dashboard.package_api_label' => 'REST API',
    'voyti.view.dashboard.package_api_description' => 'Deel uw gebruikerssysteem als moderne REST API met ingebouwde authenticatie.',
    'voyti.view.dashboard.package_gdpr_label' => 'GDPR-naleving',
    ...
    'voyti.view.dashboard.package_lockout_label' => 'Brute-Force-beveiliging',
    'voyti.view.dashboard.package_lockout_description' => 'Volg mislukte aanmeld- en registratiepogingen per IP-adres en blokkeer verdere pogingen zodra een drempel wordt bereikt.',
    ...
    'voyti.view.dashboard.package_2fa_totp_description' => 'Militaire veiligheid met authenticator-apps. veilig zelfs als wachtwoord wordt gehackt.',
    'voyti.view.dashboard.package_2fa_webauthn_label' => 'Twee-factor-authenticatie (WebAuthn)',
    'voyti.view.dashboard.package_2fa_webauthn_description' => 'De toekomst van veiligheid. biometrische of hardware-sleutelauthenticatie voor maximale bescherming.',
