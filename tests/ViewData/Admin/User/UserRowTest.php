...
final class UserRowTest extends TestCase
{
    ...
    {
        $row = UserRow::create($this->createUser(), new ModuleConfig(), new FakeUrlGenerator(), $this->createTranslator(), false, 999999);
    ...
    public function testCreateHidesForcePasswordChangeWhenDisabled(): void
    {
        ...
        $row = UserRow::create($this->createUser(), $config, new FakeUrlGenerator(), $this->createTranslator(), false, 999999);
    ...
    public function testCreateHidesSwitchIdentityWhenAlreadySwitched(): void
    {
        ...
        $row = UserRow::create($this->createUser(), $config, new FakeUrlGenerator(), $this->createTranslator(), true, 999999);
