...
final class UserModuleMigrationTest extends TestCase
{
    ...
    {
        $migration = new M260621101843_create_user_module_tables(VoytiConfigFactory::create(), TestPasswordHasherFactory::create());
        ob_start();
    ...
    {
        $migration = new M260621101843_create_user_module_tables(VoytiConfigFactory::create(), $hasher ?? TestPasswordHasherFactory::create());
        ob_start();
        $migration->up($this->builder);
