...
final class EmailChangeStrategyFactoryTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testMakeByStrategyTypeReturnsDefaultStrategyWiredWithTokenAndMailFactories(): void
    {
        $tokenFactory = $this->tokenFactory();
        $mailFactory = $this->mailFactory();
        $factory = new EmailChangeStrategyFactory($tokenFactory, $mailFactory);
        $form = $this->form();
        ...
        self::assertSame($mailFactory, $this->readProperty($strategy, 'mailFactory'));
    }
    ...
    public function testMakeByStrategyTypeReturnsSecureStrategyWrappingDefaultStrategy(): void
    {
        ...
        self::assertSame($mailFactory, $this->readProperty($inner, 'mailFactory'));
    }
    ...
    {
        return new EmailChangeStrategyFactory($this->tokenFactory(), $this->mailFactory());
    }
    ...
    {
        return new MailFactory(new MailService(
