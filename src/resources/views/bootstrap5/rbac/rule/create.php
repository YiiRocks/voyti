...
$url = $this->get('url');
?>
<?php $this->setTitle($translator->translate('voyti.view.rule.create_title', category: 'voyti')); ?>
<div class="voyti-rbac-create">
    <h1><?= $translator->translate('voyti.view.rule.create_title', category: 'voyti') ?></h1>
<?php
$form = Html::form(
    $url->generate('voyti/rules-create'),
    'post',
    ['novalidate' => true]
);
?>
