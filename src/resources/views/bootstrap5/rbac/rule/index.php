...
$url = $this->get('url');
?>
<?php $this->setTitle($translator->translate('voyti.view.rule.title', category: 'voyti')); ?>
<div class="voyti-rbac-index">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1><?= $translator->translate('voyti.view.rule.title', category: 'voyti') ?></h1>
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            ...
                            $deleteForm = Html::form(
                                $url->generate('voyti/rules-delete', ['name' => $ruleName]),
                                'post',
                                ['class' => 'd-inline']
                            );
                    ?>
