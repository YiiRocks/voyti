...
$url = $this->get('url');
?>
<?php $this->setTitle($translator->translate('voyti.view.role.update_title', ['name' => Html::encode($model->itemName)], category: 'voyti')); ?>
<div class="voyti-rbac-update">
    <h1><?= $translator->translate('voyti.view.role.update_title', ['name' => Html::encode($model->itemName)], category: 'voyti') ?></h1>
<?php
$form = Html::form(
    $url->generate('voyti/roles-update', ['name' => $model->itemName]),
    'post',
    ['novalidate' => true]
);
?>
