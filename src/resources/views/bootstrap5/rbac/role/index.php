...
<div class="voyti-rbac-index">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2 class="mb-0"><?= $translator->translate('voyti.view.role.title') ?></h2>
        <a href="<?= Html::encode($url->generate('voyti/roles-create')) ?>" class="btn btn-primary"><?= $translator->translate('voyti.view.role.create_link') ?></a>
    </div>
        ...
        <table class="table table-striped table-hover">
            <thead class="table-light">
                <tr>
                    ...
                    <th scope="col"><?= $translator->translate('voyti.view.children_header') ?></th>
            ...
            <tbody>
                <?php foreach ($items as $role): ?>
                    <tr>
                        ...
                        <td class="text-end">
                            <a href="<?= Html::encode($url->generate('voyti/roles-update', ['name' => $role->getName()])) ?>" class="btn btn-sm btn-outline-secondary"><?= $translator->translate('voyti.view.update_link') ?></a>
